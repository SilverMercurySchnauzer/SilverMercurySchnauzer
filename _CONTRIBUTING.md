...
9. git pull --rebase upstream development (ie start at step 2 again)
...
Make sure you're following the style guide below for 
commit messages in your branch as well as the pull request
